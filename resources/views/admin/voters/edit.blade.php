...
@section('content_header')
    <h1><i class="fas fa-user-edit"></i> Edit Voter</h1>
@stop
            ...
            <form action="{{ route('admin.voters.update', $voter) }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="voter_area_number" id="voter_area_number" 
                                   ...
                                   value="{{ old('voter_area_number', $voter->voter_area_number) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="voter_serial_number" id="voter_serial_number" 
                                   ...
                                   value="{{ old('voter_serial_number', $voter->voter_serial_number) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="voter_number" id="voter_number" 
                                   ...
                                   value="{{ old('voter_number', $voter->voter_number) }}" required>
                            @error('voter_number')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="father_name" id="father_name" 
                                   ...
                                   value="{{ old('father_name', $voter->father_name) }}">
                            @error('father_name')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="mother_name" id="mother_name" 
                                   ...
                                   value="{{ old('mother_name', $voter->mother_name) }}">
                            @error('mother_name')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="occupation" id="occupation" 
                                   ...
                                   value="{{ old('occupation', $voter->occupation) }}">
                            @error('occupation')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="date_of_birth" id="date_of_birth" 
                                   ...
                                   value="{{ old('date_of_birth', $voter->date_of_birth ? $voter->date_of_birth->format('Y-m-d') : '') }}">
                            @error('date_of_birth')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="address" id="address" rows="3" 
                              class="form-control @error('address') is-invalid @enderror">{{ old('address', $voter->address) }}</textarea>
                    @error('address')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="polling_center_name" id="polling_center_name" 
                                   ...
                                   value="{{ old('polling_center_name', $voter->polling_center_name) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="ward_number" id="ward_number" 
                                   ...
                                   value="{{ old('ward_number', $voter->ward_number) }}">
                            @error('ward_number')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
